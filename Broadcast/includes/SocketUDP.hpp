...
// enable o disable broadcast
int SocketUDP::broadcast(bool enable) {
	// se 1: abilito il broadcast
	// se 0: disabilito il broadcast
	int value = enable? 1:0;
	// se va tutto bene, restituisce 0
	return setsockopt(this->sock_id,
						SOL_SOCKET,
						SO_BROADCAST,
						(void*)&value,
